"""
title: AIX LLVM-IR integration helpers.
"""
...
class AixVisitor(LLVMVisitor):
    """
    title: AIX-specific backend visitor customizations.
    """

    pass


class AixBuilder(LLVMBuilder):
    """
    title: AIX backend builder with AIX overrides.
    attributes:
      translator:
        type: AixVisitor
    """
    ...
    def __init__(self) -> None:
        """
        title: Initialize AixBuilder.
        """
        super().__init__()
        self.translator: AixVisitor = self._new_translator()

    def _new_translator(self) -> AixVisitor:
        """
        title: Create the AIX visitor.
        returns:
          type: AixVisitor
        """
        return AixVisitor(
    ...
    def _build_from_ir_result(
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            file_path_o = Path(temp_dir) / "aix_module.o"
...
ArxVisitor = AixVisitor
ArxBuilder = AixBuilder
