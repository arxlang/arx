...
| Scalar arithmetic/comparisons/casts          | Complete for documented operators                          | Boolean operands and numeric conversions validated | wrapping integers, checked integer division, and `&&`/` |                                                   | ` short circuit | Partial pending floating non-finite/NaN rules; integer and Boolean rules specified |
...
| List `for ... in`                            | Complete                                                   | Complete                                           | Complete                                                | Partial pending list ownership                    |
...
| Literal and dynamic lists                    | Complete                                                   | Complete                                           | Append/index/iteration complete                         | Partial; storage reclamation is incomplete        |
